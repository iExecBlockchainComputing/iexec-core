...
public class SignatureServiceTests {
    ...
    @Test
    public void shouldAuthorizationBeValid() {
        ...
        assertEquals(expected, signatureService.computeAuthorizationHash(workerWallet, BytesUtils.stringToBytes(taskid), enclaveWallet));
    }
