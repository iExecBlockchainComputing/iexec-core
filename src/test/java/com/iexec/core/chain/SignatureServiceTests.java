...
public class SignatureServiceTests {
    ...
    public void shouldAuthorizationHashBeValid() {
        ...
        String taskid = "0xd94b63fc2d3ec4b96daf84b403bbafdc8c8517e8e2addd51fec0fa4e67801be8";
        ...
        assertEquals(expected, signatureService.computeAuthorizationHash(workerWallet, taskid, enclaveWallet));
    }
    ...
    public void shouldCreateCorrectAuthorization() {
        ...
        // creation
        ContributionAuthorization auth = signatureService.createAuthorization(workerWallet, taskid, enclaveWallet);
        ...
        ContributionAuthorization expected = ContributionAuthorization.builder()
                ...
                .sign(new Sign.SignatureData((byte)28,
