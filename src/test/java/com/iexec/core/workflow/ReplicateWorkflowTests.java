...
class ReplicateWorkflowTests {
    ...
    void workflowToJson() throws IOException {
        try {
            ...
            expectedTransitions.put(CONTRIBUTE_AND_FINALIZE_ONGOING, List.of(FAILED, WORKER_LOST, RECOVERING, ABORTED));
            expectedTransitions.put(CONTRIBUTE_AND_FINALIZE_DONE, List.of(WORKER_LOST, RECOVERING, ABORTED));
