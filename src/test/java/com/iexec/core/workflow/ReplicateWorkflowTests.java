...
class ReplicateWorkflowTests {
    ...
    void workflowToJson() throws IOException {
        try {
            ...
            expectedTransitions.put(CONTRIBUTE_AND_FINALIZE_ONGOING, List.of(CONTRIBUTE_AND_FINALIZE_FAILED, CONTRIBUTE_AND_FINALIZE_DONE, FAILED, WORKER_LOST, RECOVERING, ABORTED));
