...
public class SmsService {
    ...
    public Optional<String> getEnclaveChallenge(String chainTaskId, String dealId, int taskIndex, String smsUrl) {
    ...
    Optional<String> generateEnclaveChallenge(String chainTaskId, String dealId, int taskIndex, String smsUrl) {
