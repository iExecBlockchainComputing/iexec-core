...
| `IEXEC_CHAIN_HEALTH_MAX_CONSECUTIVE_FAILURES` | Max consecutive failures of blockchain connection check before this _Scheduler_ is declared as OUT-OF-SERVICE. | Positive integer | 4 |
